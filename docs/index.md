...
| [`bootstrap-docs`](skills/bootstrap-docs.md) | `/bootstrap-docs [--scaffold] [stack] [focus]` | Natural-language docs setup or scaffold request | Researches and recommends a documentation-site stack, then scaffolds it with real starter content from README and source on confirmation. |
